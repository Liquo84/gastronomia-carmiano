...
const SEED_PRODUCTS=[
 {id:1,cat:"Antipasti",n:"Pittule",d:"Frittelle di pasta lievitata, 10 pezzi. Anche con pomodoro o baccalà.",p:4.5,veg:true,days:ALL,limit:null},
 {id:2,cat:"Antipasti",n:"Polpette al sugo",d:"Di vitello, 6 pezzi con il loro sugo.",p:6.5,days:ALL,limit:30},
 {id:3,cat:"Antipasti",n:"Pucce farcite",d:"Puccia leccese con capocollo, caciocavallo e friarielli.",p:5,days:ALL,limit:null},
 {id:4,cat:"Antipasti",n:"Frisella al pomodoro",d:"Pomodoro, origano, olio del Salento, capperi.",p:3.5,veg:true,days:ALL,limit:null},
 {id:5,cat:"Primi",n:"Ciceri e tria",d:"Ceci e tagliatelle, in parte fritte. Il piatto della casa.",p:8,veg:true,hot:true,days:["mar","gio","sab"],limit:25},
 ...
 {id:7,cat:"Primi",n:"Orecchiette con le cime di rapa",d:"Con acciuga e mollica tostata.",p:8,days:ALL,limit:30},
 {id:8,cat:"Primi",n:"Lasagna della domenica",d:"Ragù di carne, besciamella, porzione abbondante.",p:7.5,days:["dom"],limit:40},
 {id:9,cat:"Secondi",n:"Pezzetti di cavallo al sugo",d:"Cottura lunga, pane a parte.",p:10,days:["sab","dom"],limit:15},
 {id:10,cat:"Secondi",n:"Parmigiana di melanzane",d:"Fritta, con mozzarella e basilico.",p:7,veg:true,hot:true,days:ALL,limit:20},
 {id:11,cat:"Secondi",n:"Bombette di Cisternino",d:"Capocollo e caciocavallo, 6 pezzi al forno.",p:9,days:["ven","sab","dom"],limit:20},
 ...
 {id:16,cat:"Rustici e pizze",n:"Rustico leccese",d:"Sfoglia con besciamella, pomodoro e mozzarella.",p:2,days:ALL,limit:null},
 {id:17,cat:"Rustici e pizze",n:"Pizza rustica",d:"Teglia da 8 porzioni, pomodoro e mozzarella.",p:12,veg:true,days:ALL,limit:10},
 {id:18,cat:"Rustici e pizze",n:"Panzerotto",d:"Fritto, pomodoro e mozzarella.",p:2.5,veg:true,days:ALL,limit:null},
 {id:19,cat:"Dolci",n:"Pasticciotto",d:"Frolla e crema, appena sfornato.",p:1.8,veg:true,days:ALL,limit:null},
 ...
 {id:23,cat:"Bevande",n:"Negroamaro (bottiglia 75 cl)",d:"Rosso del Salento.",p:9,days:ALL,limit:null},
];

const FORMULE=[
 {n:"Aperitivo e finger food",pp:14,l:["Pittule, rustici, pucce mignon","Frise e taralli","3 assaggi caldi","Acqua e vino della casa"]},
 {n:"Buffet completo",pp:22,l:["6 antipasti caldi e freddi","2 primi al vassoio","1 secondo con contorni","Dolce, acqua, vino"]},
